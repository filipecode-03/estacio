...
quantidade_babata = int(input("Digite a quantidade de batatas fritas desejadas: "))
quantidade_refrigerante = int(input("Digite a quantidade de refrigerantes desejados: "))

preco_total = (hamburguer * quantidade_hamburguer) + (batata_frita * quantidade_babata) + (refrigerante * quantidade_refrigerante)
